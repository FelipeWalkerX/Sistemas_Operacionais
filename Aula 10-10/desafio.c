...
void saiPrograma (int signal){  //funcao para sair do programa
    ...
    if (contador == 3)    { //Se o usuario apertar ctrl C 3 vezes, ele entra no if
        ...
        if (sair == 'y')
        {
            write(1, "Saindo...... \n", meuLen("Saindo...... \n"));   //Usuario digitou y, entao ele sai do programa
            exit(0);    //forcar encerramento do programa
        } else if (sair == 'n')
        {
            write(1, "Continuando... \n", meuLen("Continuando... \n"));   //Usuario digitou n, entao ele continua o programa
            contador = 0;
            alarm(5);
        } else{
            write(1, "Demorou muito para responder. Saindo...... \n", meuLen("Demorou muito para responder. Saindo...... \n"));       // Se deu os 20 segundos e o usuario nao digitar nada, ele encerra o programa
            exit(0);
        }
